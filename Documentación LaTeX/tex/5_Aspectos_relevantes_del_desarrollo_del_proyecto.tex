...
Las mayores ventajas que posee esta plataforma es el despliegue con un solo
comando, se encarga de toda la configuración, monitorización del servidor,
conexión remota al servidor sencilla y escalado sencillo del servidor.
