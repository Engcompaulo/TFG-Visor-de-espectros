...
class ALS_old(Baseline):
    def __init__(self, asymmetry_param=0.01, smoothness_param=1e5,
                 max_iters=10):
    ...
    def _fit_one(self, bands, intensities):
        ...
        return np.minimum(intensities,
                          baseline_als(intensities, self.smoothness_,
                                       self.asymmetry_, self.max_iters_))
