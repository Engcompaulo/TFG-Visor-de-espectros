...
class IntervalFeatures(BaseEstimator, TransformerMixin):
    ...
    def getFeatureNames(self):
        ...
        prog = np.logspace(0,max_inter_size,num=max_inter_size, base=2, endpoint=False).astype(int)
        ...
        for n in prog[1:]:
            ...
            for i in range(0,numValues-n+1,self.step_size):
                ...
                interval_name = str(self.names[interval[0]])+"-"+str(self.names[interval[-1]])
